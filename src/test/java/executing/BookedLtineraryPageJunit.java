...
public class BookedLtineraryPageJunit extends BaseClass2
{
	...
	@Test(priority = 17)
	public void BookedLtineraryPageValidation()
	{
		 bookedLtineraryPage = pageManager.bookedLtineraryPage();
		 
		WebElement bookedLtineraryPageValdation = bookedLtineraryPage.getBookedLtineraryPageValdation();
		 
		 if (bookedLtineraryPageValdation.isDisplayed()) 
	        {
	            System.out.println("we have entered the Booking Ltinerary page successfully");
	        }
	        else 
	        {
	            System.out.println("we have  Not entered the Booking Ltinerary page successfully");
	        }
	}
	@Test(priority = 18)
	public void BookedLtineraryPageCheckBox() throws InterruptedException, IOException
	{
		bookedLtineraryPage = pageManager.bookedLtineraryPage();
		WebElement checkBox = bookedLtineraryPage.getCheckBox();
		baseClass2.clickByJS(checkBox);
	
		WebElement cancel = bookedLtineraryPage.getCancel();
		baseClass2.clickByJS(cancel);
		
		Thread.sleep(1000);
		
		baseClass2.handelingAlert();
		
		baseClass2.TakeScreenshot();
		
	}
	@Test(priority = 19)
	public void BookedLtineraryClick() throws InterruptedException
	{
		bookedLtineraryPage = pageManager.bookedLtineraryPage();
		WebElement logout = bookedLtineraryPage.getLogout();
		baseClass2.clickByJS(logout);
		
		Thread.sleep(1000);
	}
	@Test(priority = 20)
	public void LoginAgainClick() throws IOException
	{
        loginAgainPage = pageManager.loginAgainPage();
		
		WebElement login = loginAgainPage.getLoginLink();
		baseClass2.clickByJS(login);
